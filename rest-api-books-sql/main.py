...
# https://restapibooks-flex.appspot.com/books
...
# https://restapibooks-flex.appspot.com/books/9780816612833
# http://127.0.0.1:8080/books/9780816612833
@app.route('/books/<isbn>')
def get_book_by_isbn(isbn):
    return_value = Book.get_book(isbn)
    return jsonify(return_value)

# POST 1/2: form to create a new book -> redirects to add_book() on submit
# https://restapibooks-flex.appspot.com/books/insertbook
# http://127.0.0.1:8080/insertbook
@app.route('/insertbook')
def insert_book():
    return render_template('insert.html')

# POST 2/2: processes the data in form and inserts the new book in db
# https://restapibooks-flex.appspot.com/books/newbook
# http://127.0.0.1:8080/newbook
...
# http://http://127.0.0.1:8080/changebook/9780816612833
# https://restapibooks-flex.appspot.com/changebook/9780816612833
...
# https://restapibooks-flex.appspot.com/replacebook
# http://http://127.0.0.1:8080/replacebook
...
# https://restapibooks-flex.appspot.com/delete/9780816612833
# http://http://127.0.0.1:8080/delete/9780816612833
